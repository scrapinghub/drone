...
func (d *Docker) Write(f *buildfile.Buildfile) {
	...
	downloadUrl := "https://get.docker.io/builds/Linux/x86_64/docker-" + d.DockerVersion + ".tgz"
	f.WriteCmd("curl -Ls " + d.downloadUrl + ".tgz |sudo tar zxf - -C /")
	f.WriteCmd("sudo chmod +x /usr/local/bin/docker")
